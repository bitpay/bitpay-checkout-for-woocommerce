...
class BillDeliveryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-BILL-DELIVERY: Failed to deliver bill-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new BillDeliveryException('My test message', 115, null, 'CUSTOM-API-CODE');
