...
class PayoutRecipientCancellationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-RECIPIENT-CANCEL: Failed to cancel payout recipient-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutRecipientCancellationException('My test message', 194, null, 'CUSTOM-API-CODE');
