...
use BitPayVendor\BitPaySDK\Exceptions\PayoutBatchNotificationException;
...
class PayoutBatchNotificationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-BATCH-NOTIFICATION: Failed to send payout batch notification-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutBatchNotificationException('My test message', 205, null, 'CUSTOM-API-CODE');
