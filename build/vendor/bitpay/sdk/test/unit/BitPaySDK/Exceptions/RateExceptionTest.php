...
use BitPayVendor\BitPaySDK\Exceptions\RateException;
...
class RateExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-RATES-GENERIC: An unexpected error occurred while trying to manage the rates-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RateException('My test message', 141, null, 'CUSTOM-API-CODE');
