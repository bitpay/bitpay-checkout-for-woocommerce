...
use BitPayVendor\BitPaySDK\Exceptions\CurrencyException;
...
class CurrencyExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-CURRENCY-GENERIC: An unexpected error occurred while trying to manage the currencies-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new CurrencyException('My test message', 181, null, 'CUSTOM-API-CODE');
