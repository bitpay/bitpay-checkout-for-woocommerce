...
class RateQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-RATES-GET: Failed to retrieve rates-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RateQueryException('My test message', 142, null, 'CUSTOM-API-CODE');
