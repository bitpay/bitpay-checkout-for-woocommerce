...
class InvoiceCreationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-INVOICE-CREATE: Failed to create invoice-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new InvoiceCreationException('My test message', 102, null, 'CUSTOM-API-CODE');
