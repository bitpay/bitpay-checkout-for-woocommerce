...
class BitPayExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-GENERIC: Unexpected Bitpay exeption.-> ', $exception->getMessage());
    }
    public function testGetApiCode()
    {
        $exception = new BitPayException('My test message', 100, null, 'CUSTOM-API-CODE');
