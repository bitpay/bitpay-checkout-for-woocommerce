...
use BitPayVendor\BitPaySDK\Exceptions\BillException;
...
class BillExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-BILL-GENERIC: An unexpected error occurred while trying to manage the bill-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new BillException('My test message', 111, null, 'CUSTOM-API-CODE');
