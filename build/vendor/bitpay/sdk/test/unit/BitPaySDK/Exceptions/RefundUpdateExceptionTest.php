...
class RefundUpdateExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-REFUND-UPDATE: Failed to update refund-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RefundUpdateException('My test message', 164, null, 'CUSTOM-API-CODE');
