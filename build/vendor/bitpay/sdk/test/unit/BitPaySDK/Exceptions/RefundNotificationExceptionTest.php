...
class RefundNotificationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-REFUND-NOTIFICATION: Failed to send refund notification-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RefundNotificationException('My test message', 166, null, 'CUSTOM-API-CODE');
