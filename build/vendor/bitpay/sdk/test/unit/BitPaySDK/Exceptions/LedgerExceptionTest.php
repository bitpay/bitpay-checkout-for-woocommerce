...
use BitPayVendor\BitPaySDK\Exceptions\LedgerException;
...
class LedgerExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-LEDGER-GENERIC: An unexpected error occurred while trying to manage the ledger-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new LedgerException('My test message', 131, null, 'CUSTOM-API-CODE');
