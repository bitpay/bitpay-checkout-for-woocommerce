...
class PayoutRecipientQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-RECIPIENT-GET: Failed to retrieve payout recipient-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutRecipientQueryException('My test message', 193, null, 'CUSTOM-API-CODE');
