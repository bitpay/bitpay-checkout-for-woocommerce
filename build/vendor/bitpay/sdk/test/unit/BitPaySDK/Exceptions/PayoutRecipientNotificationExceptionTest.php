...
class PayoutRecipientNotificationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-RECIPIENT-NOTIFICATION: Failed to send payout recipient notification-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutRecipientNotificationException('My test message', 196, null, 'CUSTOM-API-CODE');
