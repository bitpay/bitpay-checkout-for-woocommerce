...
class InvoicePaymentExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-INVOICE-PAY-UPDATE: Failed to pay invoice-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new InvoicePaymentException('My test message', 107, null, 'CUSTOM-API-CODE');
