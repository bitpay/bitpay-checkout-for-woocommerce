...
class LedgerQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-LEDGER-GET: Failed to retrieve ledger-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new LedgerQueryException('My test message', 132, null, 'CUSTOM-API-CODE');
