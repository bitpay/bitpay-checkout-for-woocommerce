...
class SettlementQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-SETTLEMENTS-GET: Failed to retrieve settlements-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new SettlementQueryException('My test message', 152, null, 'CUSTOM-API-CODE');
