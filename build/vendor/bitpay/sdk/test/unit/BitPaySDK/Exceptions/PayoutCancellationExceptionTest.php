...
class PayoutCancellationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-CANCEL: Failed to cancel payout-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutCancellationException('My test message', 124, null, 'CUSTOM-API-CODE');
