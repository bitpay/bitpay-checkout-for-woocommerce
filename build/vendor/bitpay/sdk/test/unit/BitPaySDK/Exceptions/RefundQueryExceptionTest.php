...
class RefundQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-REFUND-GET: Failed to retrieve refund-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RefundQueryException('My test message', 163, null, 'CUSTOM-API-CODE');
