...
use BitPayVendor\BitPaySDK\Exceptions\PayoutBatchCancellationException;
...
class PayoutBatchCancellationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-BATCH-CANCEL: Failed to cancel payout batch-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutBatchCancellationException('My test message', 204, null, 'CUSTOM-API-CODE');
