...
use BitPayVendor\BitPaySDK\Exceptions\SettlementException;
...
class SettlementExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-SETTLEMENTS-GENERIC: An unexpected error occurred while trying to manage the settlements-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new SettlementException('My test message', 151, null, 'CUSTOM-API-CODE');
