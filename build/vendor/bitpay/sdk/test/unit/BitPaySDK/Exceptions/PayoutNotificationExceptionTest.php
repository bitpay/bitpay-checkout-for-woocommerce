...
class PayoutNotificationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-NOTIFICATION: Failed to send payout notification-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutNotificationException('My test message', 126, null, 'CUSTOM-API-CODE');
