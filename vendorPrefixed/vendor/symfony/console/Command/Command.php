 ...
 */
namespace BitPayVendor\Symfony\Component\Console\Command;
...
use BitPayVendor\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('BitPayVendor\\setproctitle')) {
