 ...
 */
namespace BitPayVendor\Symfony\Contracts\Service\Test;

use BitPayVendor\PHPUnit\Framework\TestCase;
use BitPayVendor\Psr\Container\ContainerInterface;
use BitPayVendor\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\BitPayVendor\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\BitPayVendor\Psr\Container\ContainerExceptionInterface::class);
