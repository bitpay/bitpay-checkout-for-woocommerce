 ...
 */
namespace BitPayVendor\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'BitPayVendor\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'BitPayVendor\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'BitPayVendor\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'BitPayVendor\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'BitPayVendor\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'BitPayVendor\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
