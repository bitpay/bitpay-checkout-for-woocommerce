...
trait SanitizingFunctionsTrait
{
     ...
     */
    private $sanitizingFunctions = array('_wp_handle_upload' => \true, 'esc_url_raw' => \true, 'filter_input' => \true, 'filter_var' => \true, 'hash_equals' => \true, 'is_email' => \true, 'number_format' => \true, 'sanitize_bookmark_field' => \true, 'sanitize_bookmark' => \true, 'sanitize_email' => \true, 'sanitize_file_name' => \true, 'sanitize_hex_color_no_hash' => \true, 'sanitize_hex_color' => \true, 'sanitize_html_class' => \true, 'sanitize_meta' => \true, 'sanitize_mime_type' => \true, 'sanitize_option' => \true, 'sanitize_sql_orderby' => \true, 'sanitize_term_field' => \true, 'sanitize_term' => \true, 'sanitize_text_field' => \true, 'sanitize_textarea_field' => \true, 'sanitize_title_for_query' => \true, 'sanitize_title_with_dashes' => \true, 'sanitize_title' => \true, 'sanitize_user_field' => \true, 'sanitize_user' => \true, 'validate_file' => \true, 'wp_handle_sideload' => \true, 'wp_handle_upload' => \true, 'wp_kses_allowed_html' => \true, 'wp_kses_data' => \true, 'wp_kses_post' => \true, 'wp_kses' => \true, 'wp_parse_id_list' => \true, 'wp_redirect' => \true, 'wp_safe_redirect' => \true, 'wp_sanitize_redirect' => \true, 'wp_strip_all_tags' => \true);
    /**
     ...
     * @var array<string, bool>
     */
    private $unslashingSanitizingFunctions = array('absint' => \true, 'boolval' => \true, 'count' => \true, 'doubleval' => \true, 'floatval' => \true, 'intval' => \true, 'sanitize_key' => \true, 'sizeof' => \true);
    /**
     ...
     */
    private $addedCustomSanitizingFunctions = array('sanitize' => array(), 'unslashsanitize' => array());
    /**
    ...
    {
        if (array() === $this->allSanitizingFunctions || $this->customSanitizingFunctions !== $this->addedCustomSanitizingFunctions['sanitize']) {
            $this->allSanitizingFunctions = RulesetPropertyHelper::merge_custom_array($this->customSanitizingFunctions, $this->sanitizingFunctions);
    ...
    {
        if (array() === $this->allUnslashingSanitizingFunctions || $this->customUnslashingSanitizingFunctions !== $this->addedCustomSanitizingFunctions['unslashsanitize']) {
            $this->allUnslashingSanitizingFunctions = RulesetPropertyHelper::merge_custom_array($this->customUnslashingSanitizingFunctions, $this->unslashingSanitizingFunctions);
