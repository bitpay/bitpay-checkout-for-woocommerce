...
final class ArrayWalkingFunctionsHelper
{
     ...
     */
    private static $arrayWalkingFunctions = array('array_map' => array('position' => 1, 'name' => 'callback'), 'map_deep' => array('position' => 2, 'name' => 'callback'));
    /**
    ...
    {
        return \array_fill_keys(\array_keys(self::$arrayWalkingFunctions), \true);
    }
    /**
    ...
    public static function get_callback_parameter(File $phpcsFile, $stackPtr)
    {
        ...
        return PassedParameters::getParameter($phpcsFile, $stackPtr, self::$arrayWalkingFunctions[$functionName]['position'], self::$arrayWalkingFunctions[$functionName]['name']);
    }
}
