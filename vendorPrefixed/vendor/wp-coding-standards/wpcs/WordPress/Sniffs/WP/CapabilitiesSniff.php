...
final class CapabilitiesSniff extends AbstractFunctionParameterSniff
{
     ...
     */
    private $core_roles = array('super_admin' => \true, 'administrator' => \true, 'editor' => \true, 'author' => \true, 'contributor' => \true, 'subscriber' => \true);
    /**
    ...
    private $core_capabilities = array(
        'activate_plugin' => \true,
        'activate_plugins' => \true,
        'add_comment_meta' => \true,
        'add_post_meta' => \true,
        'add_term_meta' => \true,
        'add_user_meta' => \true,
        'add_users' => \true,
        'assign_categories' => \true,
        'assign_post_tags' => \true,
        'assign_term' => \true,
        'create_app_password' => \true,
        'create_sites' => \true,
        'create_users' => \true,
        'customize' => \true,
        'deactivate_plugin' => \true,
        'deactivate_plugins' => \true,
        'delete_app_password' => \true,
        'delete_app_passwords' => \true,
        'delete_block' => \true,
        // Only seen in tests.
        'delete_blocks' => \true,
        // Alias for 'delete_posts', but supported.
        'delete_categories' => \true,
        'delete_comment_meta' => \true,
        'delete_others_blocks' => \true,
        // Alias for 'delete_others_posts', but supported.
        'delete_others_pages' => \true,
        'delete_others_posts' => \true,
        'delete_page' => \true,
        // Alias, but supported.
        'delete_pages' => \true,
        'delete_plugins' => \true,
        'delete_post_tags' => \true,
        'delete_post' => \true,
        // Alias, but supported.
        'delete_post_meta' => \true,
        'delete_posts' => \true,
        'delete_private_blocks' => \true,
        // Alias for 'delete_private_posts', but supported.
        'delete_private_pages' => \true,
        'delete_private_posts' => \true,
        'delete_published_blocks' => \true,
        // Alias for 'delete_published_posts', but supported.
        'delete_published_pages' => \true,
        'delete_published_posts' => \true,
        'delete_site' => \true,
        'delete_sites' => \true,
        'delete_term' => \true,
        'delete_term_meta' => \true,
        'delete_themes' => \true,
        'delete_user' => \true,
        // Alias for 'delete_users', but supported.
        'delete_user_meta' => \true,
        'delete_users' => \true,
        'edit_app_password' => \true,
        'edit_categories' => \true,
        'edit_block' => \true,
        // Only seen in tests.
        'edit_blocks' => \true,
        ...
        'edit_comment' => \true,
        // Alias, but supported.
        'edit_comment_meta' => \true,
        'edit_css' => \true,
        'edit_dashboard' => \true,
        'edit_files' => \true,
        'edit_others_blocks' => \true,
        // Alias for 'edit_others_posts', but supported.
        'edit_others_pages' => \true,
        'edit_others_posts' => \true,
        'edit_page' => \true,
        // Alias, but supported.
        'edit_pages' => \true,
        'edit_plugins' => \true,
        ...
        'edit_post_meta' => \true,
        'edit_posts' => \true,
        'edit_private_blocks' => \true,
        // Alias for 'edit_private_posts', but supported.
        'edit_private_pages' => \true,
        'edit_private_posts' => \true,
        'edit_published_blocks' => \true,
        // Alias for 'edit_published_posts', but supported.
        'edit_published_pages' => \true,
        'edit_published_posts' => \true,
        'edit_term' => \true,
        'edit_term_meta' => \true,
        'edit_theme_options' => \true,
        'edit_themes' => \true,
        'edit_user' => \true,
        // Alias for 'edit_users', but supported.
        'edit_user_meta' => \true,
        'edit_users' => \true,
        'erase_others_personal_data' => \true,
        'export' => \true,
        'export_others_personal_data' => \true,
        'import' => \true,
        'install_languages' => \true,
        'install_plugins' => \true,
        'install_themes' => \true,
        'list_app_passwords' => \true,
        'list_users' => \true,
        'manage_categories' => \true,
        'manage_links' => \true,
        'manage_network' => \true,
        'manage_network_options' => \true,
        'manage_network_plugins' => \true,
        'manage_network_themes' => \true,
        'manage_network_users' => \true,
        'manage_options' => \true,
        'manage_post_tags' => \true,
        'manage_privacy_options' => \true,
        'manage_sites' => \true,
        'moderate_comments' => \true,
        'publish_blocks' => \true,
        ...
        'read_page' => \true,
        // Alias, but supported.
        'read_app_password' => \true,
        'read_private_blocks' => \true,
        // Alias for 'read_private_posts', but supported.
        'read_private_pages' => \true,
        'read_private_posts' => \true,
        'remove_user' => \true,
        ...
        'switch_themes' => \true,
        'unfiltered_html' => \true,
        'unfiltered_upload' => \true,
        'update_core' => \true,
        'update_https' => \true,
        'update_languages' => \true,
        'update_plugins' => \true,
        'update_php' => \true,
        'update_themes' => \true,
        'upgrade_network' => \true,
     ...
     */
    private $deprecated_capabilities = array('level_10' => '3.0.0', 'level_9' => '3.0.0', 'level_8' => '3.0.0', 'level_7' => '3.0.0', 'level_6' => '3.0.0', 'level_5' => '3.0.0', 'level_4' => '3.0.0', 'level_3' => '3.0.0', 'level_2' => '3.0.0', 'level_1' => '3.0.0', 'level_0' => '3.0.0');
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        $parameter = PassedParameters::getParameterFromStack($parameters, $function_details['position'], $function_details['name']);
        if (\false === $parameter) {
            return;
        }
        ...
        for ($i = $parameter['start']; $i <= $parameter['end']; $i++) {
            ...
            if (\T_CONSTANT_ENCAPSED_STRING !== $this->tokens[$i]['code'] || null !== $first_non_empty) {
                // Throw warning at low severity.
                $this->phpcsFile->addWarning('Couldn\'t determine the value passed to the $%s parameter in function call to %s(). Please check if it matches a valid capability. Found: %s', $i, 'Undetermined', array($function_details['name'], $matched_content, $parameter['clean']), 3);
                return;
            }
            $first_non_empty = $i;
        }
        ...
        if (empty($matched_parameter)) {
            $this->phpcsFile->addError('An empty string is not a valid capability. Empty string found as the $%s parameter in a function call to %s()"', $first_non_empty, 'Invalid', array($function_details['name'], $matched_content));
            return;
        }
        ...
        if (isset($this->deprecated_capabilities[$matched_parameter])) {
            ...
            $data = array($matched_parameter, $matched_content, $this->deprecated_capabilities[$matched_parameter]);
            MessageHelper::addMessage($this->phpcsFile, 'The capability "%s", found in the function call to %s(), has been deprecated since WordPress version %s.', $first_non_empty, $is_error, 'Deprecated', $data);
            return;
        }
        if (isset($this->core_roles[$matched_parameter])) {
            $this->phpcsFile->addError('Capabilities should be used instead of roles. Found "%s" in function call to %s()', $first_non_empty, 'RoleFound', array($matched_parameter, $matched_content));
            return;
        }
        $this->phpcsFile->addWarning('Found unknown capability "%s" in function call to %s(). Please check the spelling of the capability. If this is a custom capability, please verify the capability is registered with WordPress via a call to WP_Role(s)->add_cap().' . \PHP_EOL . 'Custom capabilities can be made known to this sniff by setting the "custom_capabilities" property in the PHPCS ruleset.', $first_non_empty, 'Unknown', array($matched_parameter, $matched_content));
    }
}
