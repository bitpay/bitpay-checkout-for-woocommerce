...
final class DeprecatedParameterValuesSniff extends AbstractFunctionParameterSniff
{
    ...
    {
        $parameter_position = $this->phpcsFile->findNext(Tokens::$emptyTokens, $parameter['start'], $parameter['end'] + 1, \true);
        ...
        $data = array($matched_parameter, $parameter_args[$matched_parameter]['version']);
        ...
        MessageHelper::addMessage($this->phpcsFile, $message, $parameter_position, $is_error, 'Found', $data);
    }
}
