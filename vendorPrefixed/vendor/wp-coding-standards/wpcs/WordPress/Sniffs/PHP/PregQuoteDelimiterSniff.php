...
final class PregQuoteDelimiterSniff extends AbstractFunctionParameterSniff
{
     ...
     */
    protected $target_functions = array('preg_quote' => \true);
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        $this->phpcsFile->addWarning('Passing the $delimiter parameter to preg_quote() is strongly recommended.', $stackPtr, 'Missing');
    }
}
