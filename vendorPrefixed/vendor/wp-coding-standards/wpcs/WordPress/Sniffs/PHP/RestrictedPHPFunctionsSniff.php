...
final class RestrictedPHPFunctionsSniff extends AbstractFunctionRestrictionsSniff
{
    ...
    {
        return array('create_function' => array('type' => 'error', 'message' => '%s() is deprecated as of PHP 7.2 and removed in PHP 8.0. Please use declared named or anonymous functions instead.', 'functions' => array('create_function')));
    }
}
