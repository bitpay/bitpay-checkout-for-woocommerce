...
final class StrictInArraySniff extends AbstractFunctionParameterSniff
{
     ...
     */
    protected $target_functions = array('in_array' => array('param_position' => 3, 'param_name' => 'strict', 'always_needed' => \true), 'array_search' => array('param_position' => 3, 'param_name' => 'strict', 'always_needed' => \true), 'array_keys' => array('param_position' => 3, 'param_name' => 'strict', 'always_needed' => \false));
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        if (\false === $found_parameter || 'true' !== \strtolower($found_parameter['clean'])) {
            ...
            $this->phpcsFile->addWarning('Not using strict comparison for %s; supply true for $%s argument.', isset($found_parameter['start']) ? $found_parameter['start'] : $stackPtr, $errorcode, array($matched_content, $param_info['param_name']));
        }
    }
}
