...
final class EscapedNotTranslatedSniff extends AbstractFunctionParameterSniff
{
     ...
     */
    protected $target_functions = array('esc_html' => 'esc_html__', 'esc_attr' => 'esc_attr__');
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        $data = array($matched_content, $this->target_functions[$matched_content], GetTokensAsString::compact($this->phpcsFile, $stackPtr, $closer, \true));
        $this->phpcsFile->addWarning('%s() expects only a $text parameter. Did you mean to use %s() ? Found: %s', $stackPtr, 'Found', $data);
    }
}
