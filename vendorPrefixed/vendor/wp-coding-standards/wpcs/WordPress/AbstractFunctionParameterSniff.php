...
abstract class AbstractFunctionParameterSniff extends AbstractFunctionRestrictionsSniff
{
    ...
    public function getGroups()
    {
        ...
        return array($this->group_name => array('functions' => \array_keys($this->target_functions)));
    }
    /**
     ...
     *                  normal file processing.
     */
    public abstract function process_parameters($stackPtr, $group_name, $matched_content, $parameters);
    /**
