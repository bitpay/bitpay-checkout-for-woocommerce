...
namespace BitPayVendor\GuzzleHttp\Exception;

use BitPayVendor\GuzzleHttp\BodySummarizer;
use BitPayVendor\GuzzleHttp\BodySummarizerInterface;
use BitPayVendor\Psr\Http\Client\RequestExceptionInterface;
