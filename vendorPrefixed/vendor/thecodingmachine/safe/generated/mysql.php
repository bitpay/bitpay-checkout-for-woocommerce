...
use BitPayVendor\Safe\Exceptions\MysqlException;
/**
...
{
    \error_clear_last();
    $safeResult = \BitPayVendor\mysql_create_db($database_name, $link_identifier);
    if ($safeResult === \false) {
        throw MysqlException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $safeResult = \BitPayVendor\mysql_drop_db($database_name, $link_identifier);
    if ($safeResult === \false) {
        throw MysqlException::createFromPhpError();
    }
}
