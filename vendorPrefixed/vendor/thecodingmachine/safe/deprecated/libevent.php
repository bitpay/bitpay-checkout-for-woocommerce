...
use BitPayVendor\Safe\Exceptions\LibeventException;
/**
...
{
    \error_clear_last();
    $result = \BitPayVendor\event_base_reinit($event_base);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \BitPayVendor\event_priority_set($event, $priority);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
