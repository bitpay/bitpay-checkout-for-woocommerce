...
namespace BitPayVendor\PhpParser\Lexer;

use BitPayVendor\PhpParser\Error;
use BitPayVendor\PhpParser\ErrorHandler;
use BitPayVendor\PhpParser\Lexer;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use BitPayVendor\PhpParser\Lexer\TokenEmulator\TokenEmulator;
