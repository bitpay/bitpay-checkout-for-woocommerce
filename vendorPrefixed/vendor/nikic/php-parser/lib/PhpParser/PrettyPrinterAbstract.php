...
use BitPayVendor\PhpParser\Internal\DiffElem;
use BitPayVendor\PhpParser\Internal\PrintableNewAnonClassNode;
use BitPayVendor\PhpParser\Internal\TokenStream;
...
use BitPayVendor\PhpParser\Node\Scalar;
