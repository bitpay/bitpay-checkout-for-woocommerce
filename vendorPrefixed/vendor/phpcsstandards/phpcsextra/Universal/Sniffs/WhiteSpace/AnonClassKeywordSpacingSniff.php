...
final class AnonClassKeywordSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        SpacesFixer::checkAndFix($phpcsFile, $stackPtr, $nextNonEmpty, (int) $this->spacing, 'There must be %1$s between the class keyword and the open parenthesis for an anonymous class. Found: %2$s', 'Incorrect', 'error', 0, 'Anon class: space between keyword and open parenthesis');
    }
}
