...
final class OneDeclarationPerFileSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $phpcsFile->addError('There should be only one namespace declaration per file. The first declaration was found on line %d', $stackPtr, 'MultipleFound', [$tokens[$this->declarationSeen]['line']]);
    }
}
