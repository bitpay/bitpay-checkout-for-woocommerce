    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($statements['const'] as $alias => $fullName) {
            ...
            do {
                ...
                $next = $phpcsFile->findNext(Tokens::$emptyTokens, $reportPtr + 1, $endOfStatement, \true);
            ...
            } elseif ($this->currentNamespace !== '' && (\stripos($fullName, $this->currentNamespace . '\\') === 0 || \stripos($fullName, '\\' . $this->currentNamespace . '\\') === 0)) {
                $sameNamespace = \true;
