...
final class DisallowFinalClassSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $snippet = GetTokensAsString::compact($phpcsFile, $finalKeyword, $snippetEnd, \true);
        $fix = $phpcsFile->addFixableError('Declaring a class as final is not allowed. Found: %s%s', $finalKeyword, 'FinalClassFound', [$snippet, $classCloser]);
        if ($fix === \true) {
