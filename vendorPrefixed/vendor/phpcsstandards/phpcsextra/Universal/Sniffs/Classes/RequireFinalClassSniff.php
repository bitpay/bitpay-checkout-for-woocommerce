 ...
 */
namespace BitPayVendor\PHPCSExtra\Universal\Sniffs\Classes;
...
final class RequireFinalClassSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $snippet = GetTokensAsString::compact($phpcsFile, $stackPtr, $snippetEnd, \true);
        $fix = $phpcsFile->addFixableError('A non-abstract class should be declared as final. Found: %s%s', $stackPtr, 'NonFinalClassFound', [$snippet, $classCloser]);
        if ($fix === \true) {
