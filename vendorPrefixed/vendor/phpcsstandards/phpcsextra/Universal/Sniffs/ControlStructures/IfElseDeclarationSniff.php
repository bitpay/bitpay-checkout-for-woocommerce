...
final class IfElseDeclarationSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$scopePtr]['scope_opener']) === \false || $tokens[$tokens[$scopePtr]['scope_opener']]['code'] === \T_COLON) {
        ...
        if (isset($tokens[$prevNonEmpty]['scope_condition']) === \true && ($tokens[$tokens[$prevNonEmpty]['scope_condition']]['column'] === 1 || $tokens[$tokens[$prevNonEmpty]['scope_condition'] - 1]['code'] === \T_WHITESPACE && $tokens[$tokens[$prevNonEmpty]['scope_condition'] - 1]['column'] === 1)) {
        ...
        if ($tokens[$firstOnIndentLine]['column'] !== 1) {
            ...
            if ($tokens[$firstOnIndentLine]['code'] === \T_WHITESPACE) {
                ...
                if (isset($tokens[$firstOnIndentLine]['orig_content']) === \true) {
