...
final class StrictComparisonsSniff implements Sniff
{
     ...
     * @var array
     */
    private $metricType = [\T_IS_EQUAL => 'loose', \T_IS_NOT_EQUAL => 'loose', \T_IS_IDENTICAL => 'strict', \T_IS_NOT_IDENTICAL => 'strict'];
    /**
     ...
     * @var array
     */
    private $targetTokenInfo = [\T_IS_EQUAL => ['error_code' => 'LooseEqual', 'replacement' => '==='], \T_IS_NOT_EQUAL => ['error_code' => 'LooseNotEqual', 'replacement' => '!==']];
    /**
