...
final class DisallowLogicalAndOrSniff implements Sniff
{
     ...
     * @var array
     */
    private $metricType = [\T_LOGICAL_AND => 'logical (and/or)', \T_LOGICAL_OR => 'logical (and/or)', \T_BOOLEAN_AND => 'boolean (&&/||)', \T_BOOLEAN_OR => 'boolean (&&/||)'];
    /**
     ...
     * @var array
     */
    private $targetTokenInfo = [\T_LOGICAL_AND => ['error_code' => 'LogicalAnd', 'replacement' => '&&'], \T_LOGICAL_OR => ['error_code' => 'LogicalOr', 'replacement' => '||']];
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $data = [$this->targetTokenInfo[$tokenCode]['replacement'], $tokens[$stackPtr]['content']];
