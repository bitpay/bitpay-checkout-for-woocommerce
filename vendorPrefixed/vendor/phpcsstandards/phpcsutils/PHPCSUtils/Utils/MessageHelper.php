...
final class MessageHelper
{
     ...
     * @return bool
     */
    public static function addMessage(File $phpcsFile, $message, $stackPtr, $isError = \true, $code = 'Found', array $data = [], $severity = 0)
    {
        if ($isError === \true) {
     ...
     * @return bool
     */
    public static function addFixableMessage(File $phpcsFile, $message, $stackPtr, $isError = \true, $code = 'Found', array $data = [], $severity = 0)
    {
        if ($isError === \true) {
