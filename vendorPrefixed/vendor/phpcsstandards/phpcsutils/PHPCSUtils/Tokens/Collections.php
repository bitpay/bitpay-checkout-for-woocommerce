 ...
 */
namespace BitPayVendor\PHPCSUtils\Tokens;
...
final class Collections
{
     ...
     * @var array <int> => <int>
     */
    private static $alternativeControlStructureSyntaxes = [\T_IF => \T_IF, \T_ELSEIF => \T_ELSEIF, \T_ELSE => \T_ELSE, \T_FOR => \T_FOR, \T_FOREACH => \T_FOREACH, \T_SWITCH => \T_SWITCH, \T_WHILE => \T_WHILE, \T_DECLARE => \T_DECLARE];
    /**
     ...
     * @var array <int> => <int>
     */
    private static $alternativeControlStructureSyntaxClosers = [\T_ENDIF => \T_ENDIF, \T_ENDFOR => \T_ENDFOR, \T_ENDFOREACH => \T_ENDFOREACH, \T_ENDWHILE => \T_ENDWHILE, \T_ENDSWITCH => \T_ENDSWITCH, \T_ENDDECLARE => \T_ENDDECLARE];
    /**
     ...
     */
    private static $arrayOpenTokensBC = [\T_ARRAY => \T_ARRAY, \T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $arrayTokens = [\T_ARRAY => \T_ARRAY, \T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY, \T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $classModifierKeywords = [\T_FINAL => \T_FINAL, \T_ABSTRACT => \T_ABSTRACT, \T_READONLY => \T_READONLY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $closedScopes = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE, \T_TRAIT => \T_TRAIT, \T_ENUM => \T_ENUM, \T_FUNCTION => \T_FUNCTION, \T_CLOSURE => \T_CLOSURE];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $constantModifierKeywords = [\T_PUBLIC => \T_PUBLIC, \T_PRIVATE => \T_PRIVATE, \T_PROTECTED => \T_PROTECTED, \T_FINAL => \T_FINAL];
    /**
     ...
     * @var array <int> => <int>
     */
    private static $controlStructureTokens = [\T_IF => \T_IF, \T_ELSEIF => \T_ELSEIF, \T_ELSE => \T_ELSE, \T_FOR => \T_FOR, \T_FOREACH => \T_FOREACH, \T_SWITCH => \T_SWITCH, \T_DO => \T_DO, \T_WHILE => \T_WHILE, \T_DECLARE => \T_DECLARE, \T_MATCH => \T_MATCH];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $functionDeclarationTokens = [\T_FUNCTION => \T_FUNCTION, \T_CLOSURE => \T_CLOSURE, \T_FN => \T_FN];
    /**
     ...
     * @var array <int> => <int>
     */
    private static $incrementDecrementOperators = [\T_DEC => \T_DEC, \T_INC => \T_INC];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $listOpenTokensBC = [\T_LIST => \T_LIST, \T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $listTokens = [\T_LIST => \T_LIST, \T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY, \T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $namespaceDeclarationClosers = [\T_SEMICOLON => \T_SEMICOLON, \T_OPEN_CURLY_BRACKET => \T_OPEN_CURLY_BRACKET, \T_CLOSE_TAG => \T_CLOSE_TAG];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $nameTokens = [\T_STRING => \T_STRING, \T_NAME_QUALIFIED => \T_NAME_QUALIFIED, \T_NAME_FULLY_QUALIFIED => \T_NAME_FULLY_QUALIFIED, \T_NAME_RELATIVE => \T_NAME_RELATIVE];
    /**
     ...
     * @var array <int> => <int>
     */
    private static $objectOperators = [\T_DOUBLE_COLON => \T_DOUBLE_COLON, \T_OBJECT_OPERATOR => \T_OBJECT_OPERATOR, \T_NULLSAFE_OBJECT_OPERATOR => \T_NULLSAFE_OBJECT_OPERATOR];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $ooCanExtend = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $ooCanImplement = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_ENUM => \T_ENUM];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $ooConstantScopes = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_INTERFACE => \T_INTERFACE, \T_ENUM => \T_ENUM, \T_TRAIT => \T_TRAIT];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $ooHierarchyKeywords = [\T_PARENT => \T_PARENT, \T_SELF => \T_SELF, \T_STATIC => \T_STATIC];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $ooPropertyScopes = [\T_CLASS => \T_CLASS, \T_ANON_CLASS => \T_ANON_CLASS, \T_TRAIT => \T_TRAIT];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $parameterTypeTokens = [\T_CALLABLE => \T_CALLABLE, \T_SELF => \T_SELF, \T_PARENT => \T_PARENT, \T_FALSE => \T_FALSE, \T_TRUE => \T_TRUE, \T_NULL => \T_NULL, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $phpOpenTags = [\T_OPEN_TAG => \T_OPEN_TAG, \T_OPEN_TAG_WITH_ECHO => \T_OPEN_TAG_WITH_ECHO];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $propertyModifierKeywords = [\T_PUBLIC => \T_PUBLIC, \T_PRIVATE => \T_PRIVATE, \T_PROTECTED => \T_PROTECTED, \T_STATIC => \T_STATIC, \T_VAR => \T_VAR, \T_READONLY => \T_READONLY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $propertyTypeTokens = [\T_CALLABLE => \T_CALLABLE, \T_SELF => \T_SELF, \T_PARENT => \T_PARENT, \T_FALSE => \T_FALSE, \T_TRUE => \T_TRUE, \T_NULL => \T_NULL, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $returnTypeTokens = [\T_CALLABLE => \T_CALLABLE, \T_FALSE => \T_FALSE, \T_TRUE => \T_TRUE, \T_NULL => \T_NULL, \T_TYPE_UNION => \T_TYPE_UNION, \T_TYPE_INTERSECTION => \T_TYPE_INTERSECTION];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $shortArrayListOpenTokensBC = [\T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $shortArrayTokens = [\T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY, \T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $shortListTokens = [\T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY, \T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY];
    /**
     ...
     * @var array <int|string> => <int|string>
     */
    private static $textStringStartTokens = [\T_START_HEREDOC => \T_START_HEREDOC, \T_START_NOWDOC => \T_START_NOWDOC, \T_CONSTANT_ENCAPSED_STRING => \T_CONSTANT_ENCAPSED_STRING, \T_DOUBLE_QUOTED_STRING => \T_DOUBLE_QUOTED_STRING];
    /**
    ...
    {
        \trigger_error(\sprintf('The %1$s::%2$s() method is deprecated since PHPCSUtils %3$s.' . ' Use %4$s instead.', __CLASS__, $method, $version, $replacement), \E_USER_DEPRECATED);
    }
    /**
     * Tokens which can open an array (PHPCS cross-version compatible).
     *
    ...
    {
        $tokens = [\T_NS_SEPARATOR => \T_NS_SEPARATOR, \T_NAMESPACE => \T_NAMESPACE];
        $tokens += self::$nameTokens;
        return $tokens;
    }
    /**
