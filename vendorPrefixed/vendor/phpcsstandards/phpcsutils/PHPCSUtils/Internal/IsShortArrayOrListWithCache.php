...
final class IsShortArrayOrListWithCache
{
    ...
    {
        return isset($this->tokens[$this->stackPtr]) === \true && isset(StableCollections::$shortArrayListTokensBC[$this->tokens[$this->stackPtr]['code']]) === \true;
    }
    /**
    ...
    {
        if (Cache::isCached($this->phpcsFile, self::CACHE_KEY, $this->opener) === \true) {
