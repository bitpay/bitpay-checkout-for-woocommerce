...
if (\defined('PHPCSUTILS_AUTOLOAD') === \false) {
    ...
    \define('PHPCSUTILS_AUTOLOAD', \true);
}
if (\defined('PHPCSUTILS_PHPUNIT_ALIASES_SET') === \false) {
    ...
    if (\class_exists('BitPayVendor\\PHPUnit_Framework_TestCase') === \true && \class_exists('BitPayVendor\\PHPUnit\\Framework\\TestCase') === \false) {
        \class_alias('BitPayVendor\\PHPUnit_Framework_TestCase', 'BitPayVendor\\PHPUnit\\Framework\\TestCase');
    }
    \define('PHPCSUTILS_PHPUNIT_ALIASES_SET', \true);
}
