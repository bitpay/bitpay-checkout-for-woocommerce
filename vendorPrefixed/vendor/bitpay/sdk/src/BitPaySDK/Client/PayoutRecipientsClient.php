...
class PayoutRecipientsClient
{
    ...
    public function submit(PayoutRecipients $recipients) : array
    {
        ...
        try {
            ...
            return $mapper->mapArray(\json_decode($responseJson, \true, 512, \JSON_THROW_ON_ERROR), [], PayoutRecipient::class);
        } catch (Exception $e) {
            throw new PayoutRecipientCreationException("failed to deserialize BitPay server response (PayoutRecipients) : " . $e->getMessage());
        }
    }
    /**
    ...
    public function get(string $recipientId) : PayoutRecipient
    {
        ...
        try {
            $mapper = JsonMapperFactory::create();
            return $mapper->map(\json_decode($responseJson, \true, 512, \JSON_THROW_ON_ERROR), new PayoutRecipient());
        } catch (Exception $e) {
    ...
    public function getPayoutRecipients(string $status = null, int $limit = null, int $offset = null) : array
    {
        ...
        try {
            ...
            throw new PayoutRecipientQueryException("failed to deserialize BitPay server response (PayoutRecipients) : " . $e->getMessage());
        }
    }
    /**
    ...
    public function update(string $recipientId, PayoutRecipient $recipient) : PayoutRecipient
    {
        ...
        try {
            ...
            throw new PayoutRecipientUpdateException("failed to deserialize BitPay server response (PayoutRecipient) : " . $e->getMessage());
        }
    }
    /**
    ...
    public function delete(string $recipientId) : bool
    {
        ...
        try {
            ...
            throw new PayoutRecipientCancellationException("failed to deserialize BitPay server response (PayoutRecipient) : " . $e->getMessage());
        }
    }
    /**
    ...
    public function requestNotification(string $recipientId) : bool
    {
        ...
        try {
            ...
            throw new PayoutRecipientNotificationException("failed to deserialize BitPay server response (PayoutRecipient) : " . $e->getMessage());
        }
    }
}
