...
class Refund
{
     ...
     * @param string $token
     */
    public function __construct(float $amount = 0.0, string $currency = "", string $token = "")
    {
        $this->amount = $amount;
    ...
    {
        return ['guid' => $this->getGuid(), 'amount' => $this->getAmount(), 'currency' => $this->getCurrency(), 'token' => $this->getToken(), 'id' => $this->getId(), 'requestDate' => $this->getRequestDate(), 'status' => $this->getStatus(), 'invoiceId' => $this->getInvoiceId(), 'preview' => $this->getPreview(), 'immediate' => $this->getImmediate(), 'refundFee' => $this->getRefundFee(), 'invoice' => $this->getInvoice(), 'buyerPaysRefundFee' => $this->getBuyerPaysRefundFee(), 'reference' => $this->getReference(), 'lastRefundNotification' => $this->getLastRefundNotification(), 'notificationURL' => $this->getNotificationURL(), 'refundAddress' => $this->getRefundAddress(), 'supportRequest' => $this->getSupportRequest(), 'transactionAmount' => $this->getTransactionAmount(), 'transactionCurrency' => $this->getTransactionCurrency(), 'transactionRefundFee' => $this->getTransactionRefundFee(), 'txid' => $this->getTxid(), 'type' => $this->getType()];
    }
}
