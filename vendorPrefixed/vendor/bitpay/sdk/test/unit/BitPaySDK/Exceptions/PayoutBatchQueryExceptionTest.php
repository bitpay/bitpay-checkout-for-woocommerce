...
use BitPayVendor\BitPaySDK\Exceptions\PayoutBatchQueryException;
...
class PayoutBatchQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-BATCH-GET: Failed to retrieve payout batch-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutBatchQueryException('My test message', 203, null, 'CUSTOM-API-CODE');
