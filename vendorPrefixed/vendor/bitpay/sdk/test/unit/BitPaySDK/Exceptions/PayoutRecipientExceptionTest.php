...
class PayoutRecipientExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-RECIPIENT-GENERIC: An unexpected error occurred while trying to manage the payout recipient-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutRecipientException('My test message', 191, null, 'CUSTOM-API-CODE');
