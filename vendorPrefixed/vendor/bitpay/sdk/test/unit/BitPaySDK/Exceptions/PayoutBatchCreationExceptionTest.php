...
use BitPayVendor\BitPaySDK\Exceptions\PayoutBatchCreationException;
...
class PayoutBatchCreationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-BATCH-SUBMIT: Failed to create payout batch-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutBatchCreationException('My test message', 202, null, 'CUSTOM-API-CODE');
