...
class PayoutExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-GENERIC: An unexpected error occurred while trying to manage the payout-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutException('My test message', 121, null, 'CUSTOM-API-CODE');
