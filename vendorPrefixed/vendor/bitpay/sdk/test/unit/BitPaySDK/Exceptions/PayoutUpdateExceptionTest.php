...
use BitPayVendor\BitPaySDK\Exceptions\PayoutUpdateException;
...
class PayoutUpdateExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-BATCH-UPDATE: Failed to update payout batch-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutUpdateException('My test message', 125, null, 'CUSTOM-API-CODE');
