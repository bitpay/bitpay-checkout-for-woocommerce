...
class WalletQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-WALLET-GET: Failed to retrieve supported wallets-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new WalletQueryException('My test message', 183, null, 'CUSTOM-API-CODE');
