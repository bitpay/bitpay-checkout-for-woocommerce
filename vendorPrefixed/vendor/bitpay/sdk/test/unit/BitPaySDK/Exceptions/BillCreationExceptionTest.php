...
class BillCreationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-BILL-CREATE: Failed to create bill-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new BillCreationException('My test message', 112, null, 'CUSTOM-API-CODE');
