...
class BillUpdateExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-BILL-UPDATE: Failed to update bill-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new BillUpdateException('My test message', 114, null, 'CUSTOM-API-CODE');
