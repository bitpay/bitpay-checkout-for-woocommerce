...
class InvoiceQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-INVOICE-GET: Failed to retrieve invoice-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new InvoiceQueryException('My test message', 103, null, 'CUSTOM-API-CODE');
