...
class CurrencyQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-CURRENCY-GET: Failed to retrieve currencies-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new CurrencyQueryException('My test message', 182, null, 'CUSTOM-API-CODE');
