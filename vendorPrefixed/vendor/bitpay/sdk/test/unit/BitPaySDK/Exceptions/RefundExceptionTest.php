...
use BitPayVendor\BitPaySDK\Exceptions\RefundException;
...
class RefundExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-REFUND-GENERIC: An unexpected error occurred while trying to manage the refund-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RefundException('My test message', 161, null, 'CUSTOM-API-CODE');
