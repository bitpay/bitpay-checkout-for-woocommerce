...
class BillQueryExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-BILL-GET: Failed to retrieve bill-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new BillQueryException('My test message', 113, null, 'CUSTOM-API-CODE');
