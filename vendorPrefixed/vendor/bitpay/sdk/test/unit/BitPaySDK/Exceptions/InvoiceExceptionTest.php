...
use BitPayVendor\BitPaySDK\Exceptions\InvoiceException;
...
class InvoiceExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-INVOICE-GENERIC: An unexpected error occurred while trying to manage the invoice-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new InvoiceException('My test message', 101, null, 'CUSTOM-API-CODE');
