...
class RefundCancellationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-REFUND-CANCEL: Failed to cancel refund object-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new RefundCancellationException('My test message', 165, null, 'CUSTOM-API-CODE');
