...
class InvoiceCancellationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-INVOICE-CANCEL: Failed to cancel invoice object-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new InvoiceCancellationException('My test message', 105, null, 'CUSTOM-API-CODE');
