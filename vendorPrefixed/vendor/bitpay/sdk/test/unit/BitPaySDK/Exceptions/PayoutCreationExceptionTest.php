...
class PayoutCreationExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-SUBMIT: Failed to create payout-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutCreationException('My test message', 122, null, 'CUSTOM-API-CODE');
