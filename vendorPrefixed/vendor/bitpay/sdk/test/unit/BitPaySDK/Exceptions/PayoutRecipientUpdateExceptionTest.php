...
class PayoutRecipientUpdateExceptionTest extends TestCase
{
    ...
    {
        $exception = $this->createClassObject();
        self::assertEquals('BITPAY-PAYOUT-RECIPIENT-UPDATE: Failed to update payout recipient-> ', $exception->getMessage());
    }
    ...
    {
        $exception = new PayoutRecipientUpdateException('My test message', 195, null, 'CUSTOM-API-CODE');
