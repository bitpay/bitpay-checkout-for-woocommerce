...
if (\class_exists('BitPayVendor\\PHPUnit_Framework_TestCase') === \true && \class_exists('BitPayVendor\\PHPUnit\\Framework\\TestCase') === \false) {
    \class_alias('BitPayVendor\\PHPUnit_Framework_TestCase', 'PHPUnit' . '\\Framework\\TestCase');
}
if (\class_exists('BitPayVendor\\PHPUnit_TextUI_TestRunner') === \true && \class_exists('BitPayVendor\\PHPUnit\\TextUI\\TestRunner') === \false) {
    \class_alias('BitPayVendor\\PHPUnit_TextUI_TestRunner', 'PHPUnit' . '\\TextUI\\TestRunner');
}
if (\class_exists('BitPayVendor\\PHPUnit_Framework_TestResult') === \true && \class_exists('BitPayVendor\\PHPUnit\\Framework\\TestResult') === \false) {
    \class_alias('BitPayVendor\\PHPUnit_Framework_TestResult', 'PHPUnit' . '\\Framework\\TestResult');
}
