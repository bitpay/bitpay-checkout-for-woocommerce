...
class FinallyTest extends AbstractMethodUnitTest
{
    ...
    {
        return [['/* testTryCatchFinally */'], ['/* testTryFinallyCatch */'], ['/* testTryFinally */']];
    }
    ...
    {
        return [['/* testFinallyUsedAsClassConstantName */'], ['/* testFinallyUsedAsMethodName */'], ['/* testFinallyUsedAsPropertyName */']];
    }
