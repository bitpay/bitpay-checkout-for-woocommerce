...
class BackfillMatchTokenTest extends AbstractMethodUnitTest
{
    ...
    {
        return ['switch_containing_match' => ['/* testSwitchContainingMatch */', 6, 174], 'match_containing_switch_1' => ['/* testSwitchNestedInMatch1 */', 5, 63], 'match_containing_switch_2' => ['/* testSwitchNestedInMatch2 */', 5, 63]];
    }
