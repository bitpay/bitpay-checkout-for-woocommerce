...
class GetMethodParametersTest extends AbstractMethodUnitTest
{
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var1', 'content' => '?namespace\\Name $var1', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => '?namespace\\Name', 'nullable_type' => \true];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'MyClassA|\\Package\\MyClassB $var', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'MyClassA|\\Package\\MyClassB', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = [];
        $expected[0] = ['name' => '$var', 'content' => 'MyClassA&\\Package\\MyClassB&\\Package\\MyClassC $var', 'has_attributes' => \false, 'pass_by_reference' => \false, 'variable_length' => \false, 'type_hint' => 'MyClassA&\\Package\\MyClassB&\\Package\\MyClassC', 'nullable_type' => \false];
        $this->getMethodParametersTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
