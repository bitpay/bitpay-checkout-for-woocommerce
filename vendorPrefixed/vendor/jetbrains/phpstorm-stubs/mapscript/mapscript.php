 ...
 * created using:
 */
\class_alias('BitPayVendor\\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('BitPayVendor\\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('BitPayVendor\\colorObj', 'colorObj', \false);
...
\class_alias('BitPayVendor\\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('BitPayVendor\\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('BitPayVendor\\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('BitPayVendor\\imageObj', 'imageObj', \false);
...
\class_alias('BitPayVendor\\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('BitPayVendor\\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('BitPayVendor\\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('BitPayVendor\\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BitPayVendor\\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('BitPayVendor\\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('BitPayVendor\\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('BitPayVendor\\outputformatObj', 'outputformatObj', \false);
...
\class_alias('BitPayVendor\\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('BitPayVendor\\pointObj', 'pointObj', \false);
...
\class_alias('BitPayVendor\\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('BitPayVendor\\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('BitPayVendor\\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('BitPayVendor\\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('BitPayVendor\\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('BitPayVendor\\scalebarObj', 'scalebarObj', \false);
...
\class_alias('BitPayVendor\\shapefileObj', 'shapefileObj', \false);
...
\class_alias('BitPayVendor\\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('BitPayVendor\\styleObj', 'styleObj', \false);
...
\class_alias('BitPayVendor\\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BitPayVendor\\webObj', 'webObj', \false);
