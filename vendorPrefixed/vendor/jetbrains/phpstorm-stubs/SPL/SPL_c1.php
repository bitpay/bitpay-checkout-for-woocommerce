 ...
 * @link https://php.net/manual/en/class.splfileinfo.php
 */
\class_alias('BitPayVendor\\SplFileInfo', 'SplFileInfo', \false);
/**
 ...
 * @link https://php.net/manual/en/class.directoryiterator.php
 */
\class_alias('BitPayVendor\\DirectoryIterator', 'DirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.filesystemiterator.php
 */
\class_alias('BitPayVendor\\FilesystemIterator', 'FilesystemIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.recursivedirectoryiterator.php
 */
\class_alias('BitPayVendor\\RecursiveDirectoryIterator', 'RecursiveDirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.globiterator.php
 */
\class_alias('BitPayVendor\\GlobIterator', 'GlobIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splfileobject.php
 */
\class_alias('BitPayVendor\\SplFileObject', 'SplFileObject', \false);
/**
 ...
 * @link https://php.net/manual/en/class.spltempfileobject.php
 */
\class_alias('BitPayVendor\\SplTempFileObject', 'SplTempFileObject', \false);
/**
 * @template TValue
 ...
 * @template-implements ArrayAccess<int, TValue>
 */
\class_alias('BitPayVendor\\SplDoublyLinkedList', 'SplDoublyLinkedList', \false);
/**
 * @template TValue
 ...
 * @link https://php.net/manual/en/class.splqueue.php
 */
\class_alias('BitPayVendor\\SplQueue', 'SplQueue', \false);
/**
 * @template TValue
 ...
 * @template-extends SplDoublyLinkedList<TValue>
 */
\class_alias('BitPayVendor\\SplStack', 'SplStack', \false);
/**
 * @template TValue
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('BitPayVendor\\SplHeap', 'SplHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('BitPayVendor\\SplMinHeap', 'SplMinHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('BitPayVendor\\SplMaxHeap', 'SplMaxHeap', \false);
/**
 * @template TPriority
 * @template TValue
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('BitPayVendor\\SplPriorityQueue', 'SplPriorityQueue', \false);
/**
 * @template TValue
 ...
 * @template-implements IteratorAggregate<int, TValue>
 */
\class_alias('BitPayVendor\\SplFixedArray', 'SplFixedArray', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splobserver.php
 */
\class_alias('BitPayVendor\\SplObserver', 'SplObserver', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splsubject.php
 */
\class_alias('BitPayVendor\\SplSubject', 'SplSubject', \false);
/**
 ...
 * @template-implements ArrayAccess<TObject, TValue>
 */
\class_alias('BitPayVendor\\SplObjectStorage', 'SplObjectStorage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.multipleiterator.php
 */
\class_alias('BitPayVendor\\MultipleIterator', 'MultipleIterator', \false);
