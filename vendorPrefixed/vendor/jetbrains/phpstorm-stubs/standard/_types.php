 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('BitPayVendor\\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('BitPayVendor\\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace BitPayVendor\___PHPSTORM_HELPERS;
