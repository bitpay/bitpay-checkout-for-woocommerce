 ...
 * @link https://php.net/manual/en/class.memcached.php
 */
\class_alias('BitPayVendor\\Memcached', 'Memcached', \false);
/**
 * @link https://php.net/manual/en/class.memcachedexception.php
 */
class MemcachedException extends \RuntimeException
{
    #[\BitPayVendor\JetBrains\PhpStorm\Pure]
 ...
 * @link https://php.net/manual/en/class.memcachedexception.php
 */
\class_alias('BitPayVendor\\MemcachedException', 'MemcachedException', \false);
