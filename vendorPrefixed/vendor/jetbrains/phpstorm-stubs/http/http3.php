 ...
 */
namespace BitPayVendor\http;

use BitPayVendor\http;
...
namespace BitPayVendor\http\Encoding;
 ...
 */
namespace BitPayVendor\http\Client\Curl;
...
namespace BitPayVendor\http\Client;
 ...
 */
namespace BitPayVendor\http\Client\Curl\Features;
 ...
 * These constants have been added in v2.6.0, resp. v3.1.0.
 */
namespace BitPayVendor\http\Client\Curl\Versions;
...
namespace BitPayVendor\http\Encoding\Stream;
...
namespace BitPayVendor\http\Env;
...
namespace BitPayVendor\http\Exception;
...
namespace BitPayVendor\http\Header;
...
namespace BitPayVendor\http\Message;
