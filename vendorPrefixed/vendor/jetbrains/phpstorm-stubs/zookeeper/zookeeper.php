 ...
 * @link https://www.php.net/manual/en/class.zookeeper.php
 */
\class_alias('BitPayVendor\\Zookeeper', 'Zookeeper', \false);
class ZookeeperException extends \Exception
{
}
\class_alias('BitPayVendor\\ZookeeperException', 'ZookeeperException', \false);
class ZookeeperOperationTimeoutException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperOperationTimeoutException', 'ZookeeperOperationTimeoutException', \false);
class ZookeeperConnectionException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperConnectionException', 'ZookeeperConnectionException', \false);
class ZookeeperMarshallingException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperMarshallingException', 'ZookeeperMarshallingException', \false);
class ZookeeperAuthenticationException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperAuthenticationException', 'ZookeeperAuthenticationException', \false);
class ZookeeperSessionException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperSessionException', 'ZookeeperSessionException', \false);
class ZookeeperNoNodeException extends \ZookeeperException
{
}
\class_alias('BitPayVendor\\ZookeeperNoNodeException', 'ZookeeperNoNodeException', \false);
