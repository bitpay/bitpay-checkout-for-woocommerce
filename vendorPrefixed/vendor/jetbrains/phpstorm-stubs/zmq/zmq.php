 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('BitPayVendor\\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('BitPayVendor\\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('BitPayVendor\\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('BitPayVendor\\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('BitPayVendor\\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('BitPayVendor\\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('BitPayVendor\\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('BitPayVendor\\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('BitPayVendor\\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('BitPayVendor\\ZMQDeviceException', 'ZMQDeviceException', \false);
