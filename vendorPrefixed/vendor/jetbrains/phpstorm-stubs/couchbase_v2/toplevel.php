 ...
 */
\class_alias("Couchbase\\Cluster", "BitPayVendor\\CouchbaseCluster");
\class_alias("Couchbase\\Bucket", "BitPayVendor\\CouchbaseBucket");
\class_alias("Couchbase\\MutationToken", "BitPayVendor\\CouchbaseMutationToken");
\class_alias("Couchbase\\MutationState", "BitPayVendor\\CouchbaseMutationState");
\class_alias("Couchbase\\BucketManager", "BitPayVendor\\CouchbaseBucketManager");
\class_alias("BitPayVendor\\Couchbase\\ClusterManager", "BitPayVendor\\CouchbaseClusterManager");
\class_alias("BitPayVendor\\Couchbase\\LookupInBuilder", "BitPayVendor\\CouchbaseLookupInBuilder");
\class_alias("BitPayVendor\\Couchbase\\MutateInBuilder", "BitPayVendor\\CouchbaseMutateInBuilder");
\class_alias("BitPayVendor\\Couchbase\\N1qlQuery", "BitPayVendor\\CouchbaseN1qlQuery");
\class_alias("Couchbase\\SearchQuery", "BitPayVendor\\CouchbaseSearchQuery");
\class_alias("BitPayVendor\\Couchbase\\SearchQueryPart", "BitPayVendor\\CouchbaseAbstractSearchQuery");
\class_alias("Couchbase\\QueryStringSearchQuery", "BitPayVendor\\CouchbaseStringSearchQuery");
\class_alias("Couchbase\\MatchSearchQuery", "BitPayVendor\\CouchbaseMatchSearchQuery");
\class_alias("Couchbase\\MatchPhraseSearchQuery", "BitPayVendor\\CouchbaseMatchPhraseSearchQuery");
\class_alias("Couchbase\\PrefixSearchQuery", "BitPayVendor\\CouchbasePrefixSearchQuery");
\class_alias("Couchbase\\RegexpSearchQuery", "BitPayVendor\\CouchbaseRegexpSearchQuery");
\class_alias("Couchbase\\NumericRangeSearchQuery", "BitPayVendor\\CouchbaseNumericRangeSearchQuery");
\class_alias("Couchbase\\DisjunctionSearchQuery", "BitPayVendor\\CouchbaseDisjunctionSearchQuery");
\class_alias("Couchbase\\DateRangeSearchQuery", "BitPayVendor\\CouchbaseDateRangeSearchQuery");
\class_alias("Couchbase\\ConjunctionSearchQuery", "BitPayVendor\\CouchbaseConjunctionSearchQuery");
\class_alias("Couchbase\\BooleanSearchQuery", "BitPayVendor\\CouchbaseBooleanSearchQuery");
\class_alias("Couchbase\\WildcardSearchQuery", "BitPayVendor\\CouchbaseWildcardSearchQuery");
\class_alias("Couchbase\\DocIdSearchQuery", "BitPayVendor\\CouchbaseDocIdSearchQuery");
\class_alias("Couchbase\\BooleanFieldSearchQuery", "BitPayVendor\\CouchbaseBooleanFieldSearchQuery");
\class_alias("Couchbase\\TermSearchQuery", "BitPayVendor\\CouchbaseTermSearchQuery");
\class_alias("Couchbase\\PhraseSearchQuery", "BitPayVendor\\CouchbasePhraseSearchQuery");
\class_alias("Couchbase\\MatchAllSearchQuery", "BitPayVendor\\CouchbaseMatchAllSearchQuery");
\class_alias("Couchbase\\MatchNoneSearchQuery", "BitPayVendor\\CouchbaseMatchNoneSearchQuery");
\class_alias("Couchbase\\DateRangeSearchFacet", "BitPayVendor\\CouchbaseDateRangeSearchFacet");
\class_alias("Couchbase\\NumericRangeSearchFacet", "BitPayVendor\\CouchbaseNumericRangeSearchFacet");
\class_alias("Couchbase\\TermSearchFacet", "BitPayVendor\\CouchbaseTermSearchFacet");
\class_alias("Couchbase\\SearchFacet", "BitPayVendor\\CouchbaseSearchFacet");
\class_alias("BitPayVendor\\Couchbase\\ViewQuery", "BitPayVendor\\CouchbaseViewQuery");
\class_alias("BitPayVendor\\Couchbase\\DocumentFragment", "BitPayVendor\\CouchbaseDocumentFragment");
\class_alias("BitPayVendor\\Couchbase\\Document", "BitPayVendor\\CouchbaseMetaDoc");
\class_alias("BitPayVendor\\Couchbase\\Exception", "BitPayVendor\\CouchbaseException");
\class_alias("BitPayVendor\\Couchbase\\ClassicAuthenticator", "BitPayVendor\\CouchbaseAuthenticator");
