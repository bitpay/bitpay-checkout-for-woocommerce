...
use BitPayVendor\phpDocumentor\Reflection\Type;
use BitPayVendor\PhpParser\Node;
use BitPayVendor\PhpParser\Node\AttributeGroup;
use BitPayVendor\PhpParser\Node\Expr\Array_;
use BitPayVendor\PhpParser\Node\Identifier;
use BitPayVendor\PhpParser\Node\Name;
use BitPayVendor\PhpParser\Node\NullableType;
use BitPayVendor\PhpParser\Node\Scalar\String_;
use BitPayVendor\PhpParser\Node\UnionType;
