 ...
 * Ev is a singleton providing access to the default loop and to some common operations.
 */
\class_alias('BitPayVendor\\Ev', 'Ev', \false);
/**
 * Class EvWatcher
 */
 ...
 * Class EvWatcher
 */
\class_alias('BitPayVendor\\EvWatcher', 'EvWatcher', \false);
/**
 * Class EvCheck
 *
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('BitPayVendor\\EvCheck', 'EvCheck', \false);
/**
 * Class EvChild
 *
 ...
 * It is allowed to register EvChild watchers in the default loop only.
 */
\class_alias('BitPayVendor\\EvChild', 'EvChild', \false);
/**
 * Class EvEmbed
 *
 ...
 * Used to embed one event loop into another.
 */
\class_alias('BitPayVendor\\EvEmbed', 'EvEmbed', \false);
/**
 * Class EvIo
 *
 ...
 * Always consider using non-blocking mode.
 */
\class_alias('BitPayVendor\\EvIo', 'EvIo', \false);
/**
 * Class EvPeriodic
 *
 ...
 * recursively).
 */
\class_alias('BitPayVendor\\EvPeriodic', 'EvPeriodic', \false);
/**
 * Class EvPrepare
 *
 * EvPrepare and EvCheck watchers are usually used in pairs. EvPrepare watchers get invoked before the process blocks,
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('BitPayVendor\\EvPrepare', 'EvPrepare', \false);
/**
 * Class EvSignal
 *
 ...
 * all the signals can be blocked in an EvCheck watcher and unblocked in a EvPrepare watcher.
 */
\class_alias('BitPayVendor\\EvSignal', 'EvSignal', \false);
/**
 * Class EvStat
 *
 ...
 * notifications, this can be resource-intensive.
 */
\class_alias('BitPayVendor\\EvStat', 'EvStat', \false);
/**
 * Class EvTimer
 *
 ...
 * iteration.
 */
\class_alias('BitPayVendor\\EvTimer', 'EvTimer', \false);
/**
 * Class EvIdle
 *
 ...
 * for new events.
 */
\class_alias('BitPayVendor\\EvIdle', 'EvIdle', \false);
/**
 * Class EvFork
 *
 ...
 * fork handlers will be invoked, too.
 */
\class_alias('BitPayVendor\\EvFork', 'EvFork', \false);
/**
 * Class EvLoop
 *
 ...
 * EvLoop::defaultLoop() method.
 */
\class_alias('BitPayVendor\\EvLoop', 'EvLoop', \false);
