 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandbox', 'LuaSandbox', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxFunction', 'LuaSandboxFunction', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxError', 'LuaSandboxError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxRuntimeError', 'LuaSandboxRuntimeError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxFatalError', 'LuaSandboxFatalError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxErrorError', 'LuaSandboxErrorError', \false);
/**
 ...
 * @see LuaSandbox::setMemoryLimit()
 */
\class_alias('BitPayVendor\\LuaSandboxMemoryError', 'LuaSandboxMemoryError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BitPayVendor\\LuaSandboxSyntaxError', 'LuaSandboxSyntaxError', \false);
/**
 ...
 * @see LuaSandbox::setCPULimit()
 */
\class_alias('BitPayVendor\\LuaSandboxTimeoutError', 'LuaSandboxTimeoutError', \false);
